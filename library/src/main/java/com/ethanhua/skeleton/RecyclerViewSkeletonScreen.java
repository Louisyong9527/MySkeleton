...
public class RecyclerViewSkeletonScreen implements SkeletonScreen {
    ...
    private final RecyclerViewSkeletonScreen mySkeletonScreen;

    private RecyclerViewSkeletonScreen(Builder builder) {
        mRecyclerView = builder.mRecyclerView;
        mActualAdapter = builder.mActualAdapter;
        mySkeletonScreen = builder.recyclerViewSkeleton;
    ...
    public static class Builder {
        ...
        private RecyclerViewSkeletonScreen recyclerViewSkeleton;
        ...
        public RecyclerViewSkeletonScreen build() {
            ...
            if (recyclerViewSkeleton == null){
                recyclerViewSkeleton = new RecyclerViewSkeletonScreen(this);
            }
